...
import {EventListComponent} from
  "./components/events/event-list/event-list.component";
import {TrainerListComponent} from
  "./components/trainers/trainer-list/trainer-list.component";
import {AdminPanelComponent} from
  "./components/admin-panel/admin-panel.component";
import {ConsultingListComponent} from
  "./components/consultings/consulting-list/consulting-list.component";
